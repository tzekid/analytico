...
printf 'metadata6_migration_e2e=pass predecessor=b96bc79677280367e87668811aa250300f35865a metadata=5-to-10 events=7 rows=preserved goals=preserved-active funnels=canonical-preserved duplicate_origin=failed-before-ledger rollback=matched-pair\n'
