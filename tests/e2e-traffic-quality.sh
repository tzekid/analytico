...
[[ "$quality_table" == *$'metric_version=2\ttraffic_quality_version=3\tsite=quality\tutc_range=2025-12-31..2026-01-03\treport=traffic-quality'* ]]
...
[[ "$quality_table" == *$'classifier_v1_events\t0\nshadow_verdict\tevents\nboth_human\t0\nlegacy_only\t0\nclassifier_only\t0\nboth_bot\t0'* ]]
...
[[ "$quality_csv" == *'2,3,summary,all,,,,,3,1,1,1,3333,3,,,'* ]]
[[ "$quality_csv" == *'2,3,traffic_class,human-presumed,11'* ]]
[[ "$quality_csv" == *'2,3,classifier_coverage,v1,0'* ]]
[[ "$quality_csv" == *'2,3,classifier_rule,legacy-device-bot,1'* ]]
[[ "$quality_csv" == *'2,3,day,2026-01-03,,,2,1'* ]]
