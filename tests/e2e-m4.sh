...
test "$("$binary" doctor "$source_dir")" = \
    "ok metadata=v1 events=v2 sites=2 goals=1 funnels=1 stored_events=3 key=ok"
...
test "$("$binary" doctor "$source_dir")" = \
    "ok metadata=v1 events=v2 sites=1 goals=1 funnels=1 stored_events=1 key=ok"
...
test "$("$binary" migrate "$legacy_dir")" = "migrated metadata=v1 events=v2"
test "$("$binary" doctor "$legacy_dir")" = \
    "ok metadata=v1 events=v2 sites=0 goals=0 funnels=0 stored_events=1000000 key=ok"
