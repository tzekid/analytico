...
test "$("$current" doctor "$live")" = \
    "ok metadata=v8 events=v7 sites=1 goals=0 funnels=0 stored_events=5 key=ok"
...
test "$("$current" doctor "$million")" = \
    "ok metadata=v8 events=v7 sites=1 goals=0 funnels=0 stored_events=1000000 key=ok"
