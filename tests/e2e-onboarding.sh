...
grep -Fq 'metadata=v10 events=v7' "$fixture/init.txt"
...
jq -e '
    ...
    .metadata_schema == 10 and .event_schema == 7 and
...
printf 'onboarding_e2e=pass metadata=10 events=7 sites=1 events_stored=1 cold_onboarding_rss_growth_kib=%s browser=%s\n' \
